...
#if _IS_FLASH
#define SOS_BOARD_SYSTEM_MEMORY_SIZE (128*1024UL)
#else
#define SOS_BOARD_SYSTEM_MEMORY_SIZE (64*1024UL)
#endif
...
#define SOS_BOARD_FLASH_OS_TCIM_SIZE (64*1024UL)
#define SOS_BOARD_FLASH_OS_TCIM_ADDRESS (0x00000000)
#define SOS_BOARD_FLASH_OS_TCIM_OFFSET (SOS_BOARD_FLASH_OS_OFFSET + SOS_BOARD_FLASH_OS_SIZE - SOS_BOARD_FLASH_OS_TCIM_SIZE)

#define USE_TCIM 1

#if USE_TCIM
#define SOS_BOARD_EFFECTIVE_FLASH_OS_ADDRESS SOS_BOARD_FLASH_OS_TCIM_ADDRESS
#define SOS_BOARD_EFFECTIVE_FLASH_OS_OFFSET SOS_BOARD_FLASH_OS_TCIM_OFFSET
#else
#define SOS_BOARD_EFFECTIVE_FLASH_OS_ADDRESS SOS_BOARD_FLASH_OS_ADDRESS
#define SOS_BOARD_EFFECTIVE_FLASH_OS_OFFSET SOS_BOARD_FLASH_OS_OFFSET
#endif
