...
Configuration::Configuration(Application* application)
	...
	DrawingArea label_area(1000,200);
	DrawingArea value_area(1000,225);
	DrawingArea button_area(1000,300);

	constexpr u8 label_vertical_margin = 10;
	constexpr u8 value_vertical_margin = 10;
	constexpr u8 slider_right_margin = 30;
	...
	add_component(
				...
				.add_component(
					...
					.set_align_left()
					.set_border_size(0)
					.set_vertical_margin(label_vertical_margin)
				...
				.add_component(
					...
					.set_align_left()
					.set_border_size(0)
					.set_vertical_margin(value_vertical_margin)
				...
				.add_component(
					...
					.add_component(
						...
						.set_vertical_margin(value_vertical_margin)
						.set_theme_style(Theme::style_outline_brand_secondary)
						.set_drawing_point(666, 0)
						.set_drawing_area(334,1000)
						)
				...
				.add_component(
					...
					.set_vertical_margin(value_vertical_margin)
					.set_horizontal_margin(10)
					.set_right_margin(slider_right_margin)
