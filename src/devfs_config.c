...
const devfs_device_t qspi_drive_device = DEVFS_DEVICE("qspi", mcu_qspi, 0, &qspi_dma_config, 0, 0666, SYSFS_ROOT, S_IFCHR);
...
const devfs_device_t devfs_list[] = {
	...
	//TIM1, TIM2, TIM3, and TIM4 need to be user accessible (or integrated with other drivers)
